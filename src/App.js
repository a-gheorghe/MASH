// Tutorial from https://itnext.io/using-react-hooks-with-canvas-f188d6e416c0
...
function App() {
  ...
  console.log("locations are", locations.length);
  return (
    <React.Fragment>
      ...
      <div> Number of ticks: {locations.length}</div>
      <canvas
